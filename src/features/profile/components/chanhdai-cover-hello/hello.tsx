...
import { GusWordmark } from "@/components/gus-wordmark";
// import { GusDevMark } from "@/components/gusdev-mark";
import { Button } from "@/components/ui/button";
import { SimpleTooltip } from "@/components/ui/tooltip";
import { AppleHelloVietnameseEffect } from "@/registry/apple-hello-effect";

const layers = ["hello", "gus-wordmark"] as const;
    ...
    <>
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          {layers[currentIndex] === "gus-wordmark" && (
            <motion.div
            ...
            >
              <GusWordmark className="h-12 sm:h-16" />
            </motion.div>
          )}
        </div>
      </AnimatePresence>
